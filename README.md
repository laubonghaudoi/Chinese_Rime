...
<h2>部分方案數據來源（非配方）</br>Incomplete list of sources of unmaintained schemas (non-recipes)</h2>
...
<h2>致謝（按筆畫-字母順序排列）</br>Acknowledgements (In strokes and alphabetical order)</h2>
